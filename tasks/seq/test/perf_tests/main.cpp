...
#include "seq/test/include/ops_seq.hpp"
...
TEST(sedova_o_max_of_vector_elements_seq1, test_pipeline_run_small_matrix) {
  std::random_device dev;
  std::mt19937 random(dev());
...
TEST(sedova_o_max_of_vector_elements_seq1, test_pipeline_run_large_matrix) {
  std::random_device dev;
  std::mt19937 random(dev());
...
TEST(sedova_o_max_of_vector_elements_seq1, test_pipeline_run_different_values) {
  std::random_device dev;
  std::mt19937 random(dev());
