...
TEST(sedova_o_max_of_vector_elements_mpi, Test_ValMatrix_0) {
  ...
  if (world.rank() == 0) {
    global_matr = generate_random_matrix(size, size, spread);
    taskDataPar->inputs.emplace_back(reinterpret_cast<uint8_t *>(global_matr.data()));
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_SquareMatrix_10) {
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_SquareMatrix_50) {
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_SquareMatrix_100) {
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_Matrix_10_50) {
  const size_t row = 10;
  const size_t col = 50;
  const size_t spread = 30;
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_Matrix_100_50) {
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_SquareMatrix_50_WithSeveralMax) {
  const size_t size = 50;
  const size_t spread = 30;
...
TEST(sedova_o_max_of_vector_elements_mpi, Test_Matrix_100_50_WithSeveralMax) {
  const size_t row = 100;
  const size_t col = 50;
  const size_t spread = 30;
